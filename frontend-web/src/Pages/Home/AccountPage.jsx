...
const AccountPage = ({open, close}) => {
  ...
  return (
    <div>
      ...
      >
           <Grid container justifyContent='space-between'>
             <Button sx={{color: 'black'}} onClick={close}><ArrowBackIosIcon/></Button>
             <Button sx={{marginRight: 5, color: '#537FE7',}} size='large' onClick={handleEdit}>Edit</Button>
           </Grid>
           <Grid container spacing={1} sx={{mt: 3, ml: 4}}>
             <Grid item xs={3}>
               <Avatar sx={{width: 85, height: 80}}>A</Avatar>
             </Grid>
             <Grid item xs={8}>
               <Typography variant='h5' sx={{fontWeight: 'bold'}}>xyz</Typography>
           ...
           <Grid container sx={{marginTop: 3, ml: 2}}>
             <Typography variant='h5' sx={{fontWeight: 'bold', ml: 2}}>About You</Typography>
            ...
            <Grid item xs={12} sx={{mt: 1}}>
              <Typography sx={{marginLeft: 2, fontSize: 'large'}}>Age</Typography>
                    <TextField defaultValue='25' sx={{borderColor: '#537FE7'}}
                            InputProps={{
                              readOnly: edit ? false : true,
                              sx: { borderRadius: 10, backgroundColor: 'white', height: 40, width: 300, borderColor: '#537FE7' },}}>
          ...
          <Grid container justifyContent='space-between'>
            <Button sx={{marginLeft: 2, color: '#537FE7', mt: 2}} size='large'>Logout</Button>
            <Button sx={{marginRight: 10, color: '#537FE7', mt: 2}} size='large'>Save</Button>
          </Grid>
      </SlidingPane>
    </div>
  );
